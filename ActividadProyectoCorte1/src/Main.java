            ...
            switch (opcion) {
                case "1":
                    ...
                    do {
                        ...
                        System.out.println("4. Ver asignaciones de vehiculos");
                        ...
                        switch (opcion1) {
                            case "1":
                                ...
                                Vehiculo vehiculo = new Vehiculo(marca, matricula, color);
                            ...
                            case "3":
                                ...
                                for (int i = 0; i < empresa.getChofers().size(); i++) {
                                    System.out.println((i + 1) + "." + empresa.getChofers().get(i).getNombre());
                                }
                                ...
                                for (int i = 0; i < empresa.getVehiculos().size(); i++) {
                                    System.out.println((i + 1) + "." + empresa.getVehiculos().get(i).getNombre());
                                }
                            ...
                            case "4":
                                System.out.println("--- Asignaciones de vehículos ---");
                                if (empresa.getChofers().isEmpty()) {
                                    System.out.println("No hay asignaciones de vehículos actualmente.");
                                } else {
                                    for (Chofer empleado : empresa.getChofers()) {
                                        if (empleado.getVehiculoAsignado() != null) {
                                            System.out.println("Chofer: " + empleado.getNombre() + " " + empleado.getApellido());
                                            System.out.println("Vehículo asignado: " + empleado.getVehiculoAsignado().getNombre());
                                            System.out.println("Matrícula: " + empleado.getVehiculoAsignado().getMatricula());
                                            System.out.println("Color: " + empleado.getVehiculoAsignado().getColor());
                                            System.out.println("---------------------------------");
                                        }
                                    }
                                }
